...
- (IBAction)createUser:(id)sender {
    [self.window endSheet:self.createNewUserWindow];
    [self.window beginSheet:self.gameSelectWindow completionHandler:nil];
}
...
- (IBAction)createNewUser:(id)sender {
    [self.window endSheet:self.gameSelectWindow];
    [self.window beginSheet:self.createNewUserWindow
          completionHandler:nil];
}
...
- (IBAction)startKeySigQuiz:(id)sender {
    ...
    self.keySigGame = [[JHKeySignatureGame alloc]initWithView:self.mainMusicView
