            ...
            musicFontSize:(float)musicFontSize
{
    ...
    [staff moveToPoint:NSMakePoint(xStart, yStart+(height * .75))];
    [staff lineToPoint:NSMakePoint(xStart+width, yStart+(height * .75))];
    [staff moveToPoint:NSMakePoint(xStart, yStart+(height * .5))];
    [staff lineToPoint:NSMakePoint(xStart+width, yStart+(height * .5))];
    [staff moveToPoint:NSMakePoint(xStart, yStart+(height * .25))];
    [staff lineToPoint:NSMakePoint(xStart+width, yStart+(height * .25))];
    [staff moveToPoint:NSMakePoint(xStart, yStart)];
    [staff lineToPoint:NSMakePoint(xStart+width, yStart)];
